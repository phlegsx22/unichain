...
export default function Features() {
  ...
  const issues: Issue[] = [
    ...
    { id: 'i29', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Rectification_kgkoll.png', title: 'Connect to Dapps', description: 'To Connect decentralised web applications to moblie wallets.'},
    { id: 'i30', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Claim_qcc8px.png', title: 'Ledger $ Trezor', description: 'For ledger and trezor related issues.'},
    { id: 'i31', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/fix_rargpi.png', title: 'Issues with Trading Wallet', description: 'For issues with trading wallet'},
    { id: 'i32', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Recovery_uxspvw.png', title: 'Rectification', description: 'Rectify any issue with your wallet, dex or cex.'},
    { id: 'i33', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Rectification_kgkoll.png', title: 'High Transaction fees', description: 'If you are facing an increase in transaction fees.'},
    { id: 'i34', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Claim_qcc8px.png', title: 'Validate', description: 'Facing any issues with validation'},
    { id: 'i35', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Claim_qcc8px.png', title: 'Deposits $ Withdrawals', description: 'Facing any issues with deposits, withdrawals to cex, dex?'},
    { id: 'i36', icon: 'https://www.appactivator-panel.com/Home%20Page%20_%20Welcome%20to%20Panelactivator.com_files/Claim_qcc8px.png', title: 'Swap/Exchange', description: 'For Swap/Exchange related issues'},
